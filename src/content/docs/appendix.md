...
> **注意**：以下信息截至 2026 年 3 月，请以各平台官网为准。定价可能随时调整。
...
#### 独立厂商 Coding Plan（按字母序排列）

| 厂商 | 计费模式 | 套餐与月费 | 代表模型 | 特点 |
|------|---------|-----------|---------|------|
| DeepSeek | 按量（无订阅制） | 输入 ¥2.0/M token（缓存命中 ¥0.2），输出 ¥3.0/M | V3.2, R1 | 性价比之王，可通过云厂商 Plan 间接使用 |
| Kimi（月之暗面） | 订阅制 | Andante ¥49 / Moderato ¥99 / Allegretto ¥199 / Allegro ¥699 | K2.5（256K context） | 缓存命中不消耗额度，3 倍额度已永久化 |
| MiniMax | 订阅制 | 标准：Starter ¥29 / Plus ¥49 / Max ¥119；极速：¥98–¥899 | M2.7（205K context） | Plus 及以上赠送多模态额度（语音、视频、图像） |
| 智谱 GLM | 订阅制 | Lite ¥49 / Pro ¥149 / Max ¥469 | GLM-5 / GLM-4.7（200K context） | GLM-5 消耗 3 倍额度，仅 Pro/Max 可用 |
